...
INCLUDE_PATH= \
  $(INCLUDE_QUALIFIER)C:\Users\h\Documents\MATLAB\NewGain1_ert_rtw \
  $(INCLUDE_QUALIFIER)"C:\Program Files\MATLAB\R2016b\simulink\include" \
  $(INCLUDE_QUALIFIER)"C:\Program Files\MATLAB\R2016b\extern\include" \
  $(INCLUDE_QUALIFIER)"C:\Program Files\MATLAB\R2016b\rtw\c\ert" \
  $(INCLUDE_QUALIFIER)"C:\Program Files\MATLAB\R2016b\rtw\c\rsim" \
  $(INCLUDE_QUALIFIER)"C:\Program Files\MATLAB\R2016b\rtw\c\src" \
  $(INCLUDE_QUALIFIER)"C:\Program Files\MATLAB\R2016b\rtw\c\src\ext_mode\common" \
  $(INCLUDE_QUALIFIER)"C:\Program Files\MATLAB\R2016b\rtw\c\src\ext_mode\serial" \
...
Magic.obj : Magic.cpp Magic.h    Default.h intFlowInterface.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Magic.obj" "Magic.cpp" 



Source.obj : Source.cpp Source.h    Default.h intFlowInterface.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Source.obj" "Source.cpp" 



Sink.obj : Sink.cpp Sink.h    Default.h intFlowInterface.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Sink.obj" "Sink.cpp" 



Builder.obj : Builder.cpp Builder.h    Default.h Sink.h Magic.h Source.h intFlowInterface.h 
	$(CREATE_OBJ_DIR)
...
Default.obj : Default.cpp Default.h    Magic.h Source.h Sink.h Builder.h 
	$(CREATE_OBJ_DIR)
...
NewGain1.obj : C:\Users\h\Documents\MATLAB\NewGain1_ert_rtw\NewGain1.cpp     
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"NewGain1.obj" "C:\Users\h\Documents\MATLAB\NewGain1_ert_rtw\NewGain1.cpp" 
...
clean:
	@echo Cleanup
	if exist Magic.obj erase Magic.obj
	...
	if exist NewGain1.obj erase NewGain1.obj

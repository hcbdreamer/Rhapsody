...
INCLUDE_PATH= \
  $(INCLUDE_QUALIFIER)C:\研究生课题任务\Simulink\NewGain_ert_rtw \
...
Builder.obj : Builder.cpp Builder.h    Default.h Magic.h Sink.h Source.h intFlowInterface.h 
	$(CREATE_OBJ_DIR)
...
Default.obj : Default.cpp Default.h    Source.h Sink.h Builder.h Magic.h 
	$(CREATE_OBJ_DIR)
...
NewGain.obj : C:\研究生课题任务\Simulink\NewGain_ert_rtw\NewGain.cpp     
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"NewGain.obj" "C:\研究生课题任务\Simulink\NewGain_ert_rtw\NewGain.cpp" 
...
clean:
	...
	if exist NewGain.obj erase NewGain.obj

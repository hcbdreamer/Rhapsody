...
TARGET_NAME=SystemComp

all : $(TARGET_NAME)$(EXE_EXT) SystemComp.mak

TARGET_MAIN=MainSystemComp
...
###############################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) SystemComp.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) SystemComp.mak

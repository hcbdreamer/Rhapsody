...
TARGET_NAME=SimpleQtCountdown

all : $(TARGET_NAME)$(EXE_EXT) SimpleQtCountdown.mak

TARGET_MAIN=MainSimpleQtCountdown
...
MyCountdown.obj : MyCountdown.cpp MyCountdown.h    
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"MyCountdown.obj" "MyCountdown.cpp" 
...
$(TARGET_NAME)$(EXE_EXT): $(TARGET_NAME).pro Makefile SimpleQtCountdown.mak  FORCE
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) SimpleQtCountdown.mak
	@echo Building library $@
	$(LIB_CMD) $(LIB_FLAGS) /out:$(TARGET_NAME)$(LIB_EXT) $(OBJS) $(ADDITIONAL_OBJS) $(LIBS)

clean:
	@echo Cleanup
	if exist MyCountdown.obj erase MyCountdown.obj

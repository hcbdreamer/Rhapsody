...
main.obj : main.cpp main.h    mainPkg.h Idisplay.h Iinput.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"main.obj" "main.cpp" 



test.obj : test.cpp test.h    HardwarePkg.h Iinput.h mainPkg.h Idisplay.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"test.obj" "test.cpp" 



Builder.obj : Builder.cpp Builder.h    HardwarePkg.h main.h test.h Iinput.h Idisplay.h 
	$(CREATE_OBJ_DIR)
...
Iinput.obj : Iinput.cpp Iinput.h    InterfacePkg.h mainPkg.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Iinput.obj" "Iinput.cpp" 



mainPkg.obj : mainPkg.cpp mainPkg.h    main.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"mainPkg.obj" "mainPkg.cpp" 



HardwarePkg.obj : HardwarePkg.cpp HardwarePkg.h    test.h Builder.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"HardwarePkg.obj" "HardwarePkg.cpp" 



InterfacePkg.obj : InterfacePkg.cpp InterfacePkg.h    Idisplay.h Iinput.h 
	$(CREATE_OBJ_DIR)
...
clean:
	...
	if exist test.obj erase test.obj
	if exist Builder.obj erase Builder.obj
	if exist Idisplay.obj erase Idisplay.obj
	if exist Iinput.obj erase Iinput.obj
	if exist mainPkg.obj erase mainPkg.obj
	if exist HardwarePkg.obj erase HardwarePkg.obj

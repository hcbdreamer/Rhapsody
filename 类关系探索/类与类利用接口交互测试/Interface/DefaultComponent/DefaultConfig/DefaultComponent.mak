...
test.obj : test.cpp test.h    TestPkg.h IOut.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"test.obj" "test.cpp" 



test1.obj : test1.cpp test1.h    HardwarePkg.h IOut.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"test1.obj" "test1.cpp" 



Builder.obj : Builder.cpp Builder.h    HardwarePkg.h test.h test1.h IOut.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Builder.obj" "Builder.cpp" 



IOut.obj : IOut.cpp IOut.h    InterfacePkg.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"IOut.obj" "IOut.cpp" 



TestPkg.obj : TestPkg.cpp TestPkg.h    test.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"TestPkg.obj" "TestPkg.cpp" 



HardwarePkg.obj : HardwarePkg.cpp HardwarePkg.h    test1.h Builder.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"HardwarePkg.obj" "HardwarePkg.cpp" 



InterfacePkg.obj : InterfacePkg.cpp InterfacePkg.h    IOut.h 
	$(CREATE_OBJ_DIR)
...
clean:
	...
	if exist test1.obj erase test1.obj
	if exist Builder.obj erase Builder.obj
	if exist IOut.obj erase IOut.obj

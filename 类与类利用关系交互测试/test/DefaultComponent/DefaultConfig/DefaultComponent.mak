...
man.obj : man.cpp man.h    Default.h woman.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"man.obj" "man.cpp" 



woman.obj : woman.cpp woman.h    Default.h man.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"woman.obj" "woman.cpp" 



Builder.obj : Builder.cpp Builder.h    Default.h man.h woman.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Builder.obj" "Builder.cpp" 



Default.obj : Default.cpp Default.h    man.h woman.h Builder.h 
	$(CREATE_OBJ_DIR)
...
clean:
	@echo Cleanup
	if exist man.obj erase man.obj
	if exist woman.obj erase woman.obj

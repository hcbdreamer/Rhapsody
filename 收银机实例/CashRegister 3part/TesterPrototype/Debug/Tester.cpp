...
static AOMClass* _TesterSuper[3] = {
OMAnimatedIDisplay::staticGetClass(),
OMAnimatedIBarcodeReaderEnabled::staticGetClass(),
OMAnimatedIKeyboardEnabled::staticGetClass()};
//#]

IMPLEMENT_REACTIVE_META_M_P(Tester, HardwarePkg::TesterPkg, false, _TesterSuper, 3, OMAnimatedTester)

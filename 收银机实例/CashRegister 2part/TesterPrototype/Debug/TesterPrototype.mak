...
CashRegister.obj : CashRegister.cpp CashRegister.h    CashRegisterPkg.h ProductDatabase.h Product.h Iprinter.h IDisplay.h 
	$(CREATE_OBJ_DIR)
...
Tester.obj : Tester.cpp Tester.h    TesterPkg.h Iprinter.h IBarcodeReaderEnabled.h IKeyboardEnabled.h IDisplay.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Tester.obj" "Tester.cpp" 



TesterBuilder.obj : TesterBuilder.cpp TesterBuilder.h    TesterPkg.h CashRegister.h Tester.h IDisplay.h 
	$(CREATE_OBJ_DIR)

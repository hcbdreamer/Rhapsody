...
CashRegister::CashRegister(IOxfActive* theActiveContext) {
...
#ifdef _OMINSTRUMENT
IMPLEMENT_REACTIVE_META_P(CashRegister, CashRegisterPkg, CashRegisterPkg, false, OMAnimatedCashRegister)
#endif // _OMINSTRUMENT

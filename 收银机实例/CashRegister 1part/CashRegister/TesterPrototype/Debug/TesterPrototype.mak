...
CashRegister.obj : CashRegister.cpp CashRegister.h    CashRegisterPkg.h ProductDatabase.h Product.h Iprinter.h IDisplay.h IBarcodeReaderEnabled.h IKeyboardEnabled.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"CashRegister.obj" "CashRegister.cpp" 



ProductDatabase.obj : ProductDatabase.cpp ProductDatabase.h    CashRegisterPkg.h Product.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"ProductDatabase.obj" "ProductDatabase.cpp" 



Product.obj : Product.cpp Product.h    CashRegisterPkg.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Product.obj" "Product.cpp" 



IBarcodeReaderEnabled.obj : IBarcodeReaderEnabled.cpp IBarcodeReaderEnabled.h    InterfacePkg.h 
	$(CREATE_OBJ_DIR)
...
IKeyboardEnabled.obj : IKeyboardEnabled.cpp IKeyboardEnabled.h    InterfacePkg.h 
	$(CREATE_OBJ_DIR)
...
Tester.obj : Tester.cpp Tester.h    TesterPkg.h Iprinter.h IDisplay.h IBarcodeReaderEnabled.h IKeyboardEnabled.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Tester.obj" "Tester.cpp" 



TesterBuilder.obj : TesterBuilder.cpp TesterBuilder.h    TesterPkg.h CashRegister.h Tester.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"TesterBuilder.obj" "TesterBuilder.cpp" 



CashRegisterPkg.obj : CashRegisterPkg.cpp CashRegisterPkg.h    CashRegister.h ProductDatabase.h Product.h 
	$(CREATE_OBJ_DIR)
...
TesterPkg.obj : TesterPkg.cpp TesterPkg.h    Tester.h TesterBuilder.h 
	$(CREATE_OBJ_DIR)
